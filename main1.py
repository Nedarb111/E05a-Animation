...
"""
    ...
    #This is setting the screen's width and height, but it's established below in a more advanced way
import arcade
...
class MyGame(arcade.Window):
    ...
    def on_mouse_release(self, x, y, button, modifiers):
        ...
        #This is setting the display for the game and the window that it's set in!
def main():
